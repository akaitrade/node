...
class MethodDescription(object):
    ...
    def __init__(self, returnType=None, name=None, arguments=None, annotations=None, modifiers=None, address=None,):
    ...
    def write(self, oprot):
        ...
        if self.annotations is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.annotations))
            for iter72 in self.annotations:
                iter72.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.modifiers is not None:
            oprot.writeFieldBegin('modifiers', TType.LIST, 5)
            oprot.writeListBegin(TType.STRING, len(self.modifiers))
            for iter73 in self.modifiers:
...
class MethodSignature(object):
    ...
    def __init__(self, signature=None, address=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('MethodSignature')
...
class MethodShortArgument(object):
    """
    Attributes:
     - type
     - name
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('MethodShortArgument')
        if self.type is not None:
            oprot.writeFieldBegin('type', TType.STRING, 1)
            oprot.writeString(self.type.encode('utf-8') if sys.version_info[0] == 2 else self.type)
            oprot.writeFieldEnd()
...
class MethodShortDescription(object):
    """
    Attributes:
     - name
     - retValues
    ...
    def __init__(self, name=None, retValues=None, arguments=None, modifiers=None, address=None,):
        self.name = name
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i78 in range(_size74):
                        _elem79 = MethodShortArgument()
                        _elem79.read(iprot)
                        self.retValues.append(_elem79)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i84 in range(_size80):
                        _elem85 = MethodShortArgument()
                        _elem85.read(iprot)
                        self.arguments.append(_elem85)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('MethodShortDescription')
        if self.name is not None:
            oprot.writeFieldBegin('name', TType.STRING, 1)
            oprot.writeString(self.name.encode('utf-8') if sys.version_info[0] == 2 else self.name)
            oprot.writeFieldEnd()
        if self.retValues is not None:
            oprot.writeFieldBegin('retValues', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.retValues))
            for iter92 in self.retValues:
                iter92.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.arguments is not None:
            oprot.writeFieldBegin('arguments', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.arguments))
            for iter93 in self.arguments:
                iter93.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.modifiers is not None:
            oprot.writeFieldBegin('modifiers', TType.LIST, 4)
            oprot.writeListBegin(TType.STRING, len(self.modifiers))
            for iter94 in self.modifiers:
...
MethodDescription.thrift_spec = (
    ...
    (5, TType.LIST, 'modifiers', (TType.STRING, 'UTF8', False), None, ),  # 5
...
all_structs.append(MethodSignature)
MethodSignature.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'signature', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'address', 'BINARY', None, ),  # 2
)
all_structs.append(MethodShortArgument)
MethodShortArgument.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'type', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'name', 'UTF8', None, ),  # 2
)
all_structs.append(MethodShortDescription)
MethodShortDescription.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'retValues', (TType.STRUCT, [MethodShortArgument, None], False), None, ),  # 2
    (3, TType.LIST, 'arguments', (TType.STRUCT, [MethodShortArgument, None], False), None, ),  # 3
    (4, TType.LIST, 'modifiers', (TType.STRING, 'UTF8', False), None, ),  # 4
